...
/****************************************************************************************
* STduino Earth (STM32F103) pin assignment
*
****************************************************************************************/
#if MOTHERBOARD == 100
#define KNOWN_BOARD 1
...
#error Oops!  Make sure you have 'STduino Earth w/ STM32F103' selected from the 'Tools -> Boards' menu.
#endif
...
#define E_STEP_PIN         25//11
#define E_DIR_PIN          26//12
#define E_ENABLE_PIN       -1
...
/****************************************************************************************
* MakerLab DLP Controller (STM32F103) pin assignment
*
****************************************************************************************/
#if MOTHERBOARD == 101
#define KNOWN_BOARD 1
...
#define X_MIN_PIN          14//A0
#define X_MAX_PIN          -1

#define Y_STEP_PIN         4
#define Y_DIR_PIN           3
#define Y_ENABLE_PIN       10
#define Y_MIN_PIN           15//A1
#define Y_MAX_PIN          -1
...
#if Z_HOME_DIR == 1//home to max
#define Z_MIN_PIN           -1
#define Z_MAX_PIN          18//A4
#else
#define Z_MIN_PIN           18//A4
#define Z_MAX_PIN          -1
#endif

#define E_STEP_PIN         5//11
#define E_DIR_PIN          6//12
#define E_ENABLE_PIN       -1
