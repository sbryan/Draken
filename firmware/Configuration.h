...
// Projector Settings on or off
#define PROJECTOR_CTRL
#define PJSerial Serial1 //for projector control
// Projector types
// 1 is ViewSonic PJD7820HD
// 2 is Acer H6510BD
#define PROJECTOR 2

//// Calibration variables
// X, Y, Z, E steps per unit - Metric Prusa Mendel with Wade extruder:
#define _AXIS_STEP_PER_UNIT {80, 80, 800,700}
...
//-----------------------------------------------------------------------
const int16_t X_MAX_LENGTH = 200;
const int16_t Y_MAX_LENGTH = 200;
const int16_t Z_MAX_LENGTH = 200;

//-----------------------------------------------------------------------
//// MOVEMENT SETTINGS
//-----------------------------------------------------------------------
const int16_t NUM_AXIS = 4; // The axis order in all axis related arrays is X, Y, Z, E
#define _MAX_FEEDRATE {400, 400, 5, 45}       // (mm/sec)
...
const int16_t dropsegments=5; //everything with less than this number of steps will be ignored as move and joined with the next movement
