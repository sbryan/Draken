...
//======================================================================================
//========================= Read / Write EEPROM =======================================
template <class T> int16_t EEPROM_write_setting(int16_t address, const T& value)
{
  const byte* p = (const byte*)(const void*)&value;
  int16_t i;
  for (i = 0; i < (int16_t)sizeof(value); i++)
    eeprom_write_byte((unsigned char *)address++, *p++);
  return i;
}

template <class T> int16_t EEPROM_read_setting(int16_t address, T& value)
{
